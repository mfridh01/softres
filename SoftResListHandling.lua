...
function SoftRes.list:showFullSoftResList()
    ...
    local infoText = "Raid: " .. offlineColor .. numOffline .. "|r/" .. raidTextColor .. numGroupMembers .. "|r || List: " .. listEntryColor .. listEntries .. "|r || Res: " .. entryText .. (listEntries - notSoftReserved) .. "/" .. listEntries .. "|r.\n-----------------------------------------------------------------------\n"
...
----------------------------
function SoftRes.list:addSoftReservePlayer(playerName, itemId, received)
    ...
    table.insert(SoftResList.players, lastIndex, SoftRes.player:new(playerName, 0, itemId, received))
end
